...
const App = () => {
    ...
    useEffect(() => {
        if (formData.price > 0) {
            const mockDividend = 200; // 仮の配当金
            const yoc = (mockDividend / formData.price) * 100;
            setEstimatedYoc(yoc.toFixed(2));
        } else {
            setEstimatedYoc(0);
        }
    }, [formData.price]);
    ...
    return (
        <div className="relative w-full h-screen bg-[#052e16] flex flex-col items-center justify-center overflow-hidden font-sans">
                ...
                <div className="bg-white/95 backdrop-blur-2xl border border-white/20 rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.4)] overflow-hidden">
                    ...
                    <div className="relative p-8">
                        ...
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <button className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-400 hover:text-slate-600 transition-colors">
                                <X size={20} />
                            </button>
                        </div>
